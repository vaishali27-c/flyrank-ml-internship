...
The project can be reproduced using the notebooks available in the GitHub repository. The workflow consists of the following steps:

- 1. Clone the project repository.

- 2. Install the required Python packages from requirements.txt.

- 3. Configure a Hugging Face Read Token as the HF_TOKEN secret.
...
The implementation uses Python together with pandas, NumPy, DuckDB, scikit-learn, and Matplotlib. Where applicable, experiments were executed using a random seed of 42 to improve reproducibility. All generated outputs can be recreated by rerunning the notebooks
